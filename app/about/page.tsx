...
export default function About() {
    return (
        <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#EAE0CF' }}>
            <div className="py-32 md:py-60 max-w-5xl mx-auto px-6 sm:px-6 lg:px-0 flex-grow">
                ...
                <div className="flex flex-col md:flex-row items-center gap-16 md:gap-12">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        <p className="font-dogica text-lg md:text-xl font-bold mb-8" style={{ color: '#000000' }}>
                        ...
                        <p className="font-dogica text-lg md:text-xl font-bold" style={{ color: '#000000' }}>
